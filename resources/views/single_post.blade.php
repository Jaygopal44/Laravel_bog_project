                            ...
                            <div class="top-wrapper">
                                <div class="row d-flex justify-content-between">
                                    ...
                                    <div class="col-lg-4 col-md-12 right-side d-flex justify-content-end">
                                        ...
                                        <div class="user-img">
                                            {{-- <img src="{{ asset('upload/'.$post->image) }}" alt="" /> --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row flex-column">
                                        ...
                                        @foreach ($post->comments as $c)
                                            <div class="comment">
                                                <div class="comment-list">
                                                    <div class="single-comment justify-content-between d-flex">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb">
                                                                <img src="{{ asset('upload/user/' . $c->user->image) }}"
                                                                    alt="" width="60px" />
                                                            </div>
                                                            <div class="desc">
                                                        ...
                                                        <div class="">
                                                            <button class="btn-reply text-uppercase" id="reply-btn"
                                                                onclick="showReplyForm('{{ $c->id }}','{{ $c->user->name }}')">Reply</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    @foreach ($c->replies as $reply)
                                                        <div class="comment-list left-padding">
                                                            <div class="single-comment justify-content-between d-flex">
                                                                <div class="user justify-content-between d-flex">
                                                                    <div class="thumb">
                                                                        <img src="{{ asset('upload/user/' . $reply->user->image) }}"
                                                                            alt="" width="50px" />
                                                                    </div>
                                                                    <div class="desc">
                                                                        ...
                                                                        <p class="date">
                                                                            {{ $c->created_at->format('D, d M Y H:i') }}
                                                                        </p>
                                                                        <p class="comment">
                                                                            {{ $reply->message }}
                                                                        </p>
                                                                ...
                                                                <div class="">
                                                                    <button class="btn-reply text-uppercase" id="reply-btn"
                                                                        onclick="showReplyForm('{{ $c->id }}','{{ $reply->user->name }}')">Reply</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                ...
                                                @endif
                                                <div class="comment-list left-padding"
                                                    id="reply-form-{{ $c->id }}" style="display: none">
                                                    <div class="single-comment justify-content-between d-flex">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb">
                                                                <img src="{{ asset('upload/user/' . $reply->user->image) }}"
                                                            ...
                                                            <div class="desc">
                                                                ...
                                                                <div class="row flex-row d-flex">
                                                                    <form action="{{ url('comment_reply', $c->id) }}"
                                                                        ...
                                                                        @csrf
                                                                        <div class="col-lg-12">
                                                                            <textarea id="reply-form-{{ $c->id }}-text" cols="60" rows="2" class="form-control mb-10"
